		...
		return (
			<Layout touch-action="manipulation">
				<Header
					...
					title={
						<div style={{ textDecoration: 'none', color: 'white' }} onClick={this.handleLandingPageClick}>
							Portfolio
						</div>
					}
					scroll
				>
					<Navigation>
						<div style={{ fontSize: '19px' }} onClick={this.handleResumeClick}>
							Resume
						</div>
						<div style={{ fontSize: '19px' }} onClick={this.handleProjectsClick}>
							Projects
						</div>
						<div style={{ fontSize: '19px' }} onClick={this.handleAboutMeClick}>
							Who I am
						</div>
						<div style={{ fontSize: '19px' }} onClick={this.handleContactClick}>
							Contact
						</div>
					</Navigation>
				</Header>
				<Drawer
					title={
						<div style={{ textDecoration: 'none', color: 'black' }} onClick={this.handleLandingPageClick}>
							Portfolio
						</div>
					}
				>
				...
				<Content>
					<div className="App">
						...
						<div hidden={this.state.projects_hidden}>
							<Projects />
						</div>
